...
export const editFileName = async function (req, file, callback) {
  ...
  var fs = require('fs');
  //C:\Users\jaehunchoi\TriQuiz\BackEnd\triquiz-be\src\utils\file-upload.utils.ts
  //C:\Users\jaehunchoi\TriQuiz\BackEnd\triquiz-be\image_upload
  var randomName;
  ...
  while (true) {
    var path = `${testFolder}${hash}${randomName}${fileExtName}`;
